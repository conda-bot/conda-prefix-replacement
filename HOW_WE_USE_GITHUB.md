...
<!-- relative URLs -->
[workflow-cla]: https://github.com/conda/conda-prefix-replacement/blob/main/.github/workflows/cla.yml
[workflow-issues]: https://github.com/conda/conda-prefix-replacement/blob/main/.github/workflows/issues.yml
[workflow-labels]: https://github.com/conda/conda-prefix-replacement/blob/main/.github/workflows/labels.yml
[workflow-lock]: https://github.com/conda/conda-prefix-replacement/blob/main/.github/workflows/lock.yml
[workflow-project]: https://github.com/conda/conda-prefix-replacement/blob/main/.github/workflows/project.yml
[workflow-stale]: https://github.com/conda/conda-prefix-replacement/blob/main/.github/workflows/stale.yml
[labels-local]: https://github.com/conda/conda-prefix-replacement/blob/main/.github/labels.yml
[labels-page]: https://github.com/conda/conda-prefix-replacement/labels
...
- [Marking/Closing stale issues and pull requests][workflow-stale]:
  - https://github.com/conda/conda-prefix-replacement/labels/type%3A%3Asupport issues are labeled as stale after 21 days of inactivity and are closed after 7 more days of inactivity (that is, closed after 30 inactive days total)
  - non https://github.com/conda/conda-prefix-replacement/labels/type%3A%3Asupport issues are labeled as stale after 365 days of inactivity and are closed after 30 more days of inactivity (that is, closed after an approximate total of 1 year and 1 month of inactivity)
...
- [Indicating an issue is ready for a maintainer's attention][workflow-issues] by toggling https://github.com/conda/conda-prefix-replacement/labels/pending%3A%3Afeedback with https://github.com/conda/conda-prefix-replacement/labels/pending%3A%3Asupport after a contributor leaves a comment
...
> **Warning**
> Apply the https://github.com/conda/conda-prefix-replacement/labels/duplicate label to the issue being closed and https://github.com/conda/conda-prefix-replacement/labels/duplicate%3A%3Aprimary to the original issue.
...
<!-- see https://github.com/orgs/community/discussions/16925#discussioncomment-9542248 -->
> **Warning**
> Apply the https://github.com/conda/conda-prefix-replacement/labels/off-topic  label to these issues before closing them out.
...
Generally speaking, labels with the same category are considered mutually exclusive, but in some cases labels sharing the same category can occur concurrently, as they indicate qualifiers as opposed to types. For example, we may have the following types, https://github.com/conda/conda-prefix-replacement/labels/type%3A%3Abug, https://github.com/conda/conda-prefix-replacement/labels/type%3A%3Afeature, and https://github.com/conda/conda-prefix-replacement/labels/type%3A%3Adocumentation, where for any one issue there would be _at most_ **one** of these to be defined (_i.e._ an issue should not be a bug _and_ a feature request at the same time). Alternatively, with issues involving specific operating systems (_i.e._, https://github.com/conda/conda-prefix-replacement/labels/os%3A%3Alinux, https://github.com/conda/conda-prefix-replacement/labels/os%3A%3Amacos, and https://github.com/conda/conda-prefix-replacement/labels/os%3A%3Awindows), an issue could be labeled with one or more, depending on the system(s) the issue occurs on.

Please note that there are also automation policies in place that are affected by labeling. For example, if an issue is labeled as https://github.com/conda/conda-prefix-replacement/labels/type%3A%3Asupport, that issue will be marked https://github.com/conda/conda-prefix-replacement/labels/stale after 21 days of inactivity and auto-closed after seven more days without activity (30 inactive days total), which is earlier than issues without this label. See [What automation procedures are currently in place?](#what-automation-procedures-are-currently-in-place) for more details.
...
The `severity` labels are exclusive of each other and, while required for the https://github.com/conda/conda-prefix-replacement/labels/type%3A%3Abug label, they can also be applied to other types to indicate demand or need. These labels help us to prioritize our work. Severity is not the only factor for work prioritization, but it is an important consideration.
